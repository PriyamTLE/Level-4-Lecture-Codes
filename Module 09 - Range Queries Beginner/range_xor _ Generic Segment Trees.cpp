...
struct SegTree {
    ...
    void make_update(int index, ll x, ll y) {  // pass in as many parameters as required
        Update new_update = Update(x, y); // may change
...
struct Update1 {
    ll x, y; // may change
    Update1(ll x1, ll y1) { // Actual Update
        x = x1; // may change
        y = y1;
    }
